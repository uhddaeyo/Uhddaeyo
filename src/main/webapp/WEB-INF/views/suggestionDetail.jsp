	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2" style="margin-top: 45px; margin-right: 30px">
				...
				<div class="list-group"
					...
					<a href="${pageContext.request.contextPath}/reqList"
						class="list-group-item">나의 요청내역</a> 
						<a
			...
			<div class="col-lg-9">
				...
				<h2 style="margin-top: 55px;">${sdto.place_name}</h2>
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner" style="height: 200px;" data-cycle-fx="scrollHorz" >
					  	<c:forEach items="${pictures}" var="picture" varStatus="status">
					  		<c:choose>
					  			<c:when test="${status.index == 0}">
								    <div class="carousel-item active">
								      <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/placeImages/${picture}" alt="First slide">
								    </div>			  				
					  			</c:when>
					  			<c:otherwise>
								    <div class="carousel-item">
								      <img class="d-block w-100" src="${pageContext.request.contextPath}/resources/placeImages/${picture}" alt="Second slide">
								    </div>					  			
					  			</c:otherwise>
					  		</c:choose>					  		
					  	</c:forEach>					  	
				...
				<div class="card">
				  ...
				  <div class="card-body">
				    <h5 class="card-title">초대 메시지</h5><br>
					<h6>${sdto.message }</h6>
					<hr>
				    <p class="card-text">
