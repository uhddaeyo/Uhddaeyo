            ...
            <td>
               ...
               <form:form commandName="host" id="form1" name="form1" method="post"
                  ...
                  <div class="form-group row">
                     ...
                     <div style="width: 58%;">
                        <p style="padding:10px; margin-bottom:0">오픈 시간</p> <form:input type="time" class='form-control' step="1800"
                           path="place.startTime" id="place.startTime" required="required"/> 
                        <p style="padding:10px; margin-bottom:0">마감 시간</p><form:input type="time" class='form-control' step="1800"
                  ...
                  <div class="form-group row">
                     ...
                     <div style="width: 58%;">
                        <input type="text" class="form-control" id="place.address" path="place.address"
                           placeholder="주소를 입력하세요" required autofocus>
                     </div>
                  </div>
